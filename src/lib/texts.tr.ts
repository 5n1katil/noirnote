...
export const textsTR = {
  ...
  cases: {
    ...
    case002: {
      ...
      clues: {
        clue1: "Cinayet Servis Koridoru'nda işlenmedi.",
        clue2: "Merdiven Boşluğu'nda ayakkabı izi bulunmadı.",
        clue3: "Kurbanın odasında cam kırığı bulunmadı.",
        clue4: "Cinayet zehirli bir içecekle işlendi.",
        clue5: "Deniz'in anahtar kartı oda kapılarını açmaz.",
        clue6: "Mert, görev sırasında odalara giremez.",
      },
    },
  },
  suspects: {
    ...
    bio007: "Oda Hizmetleri Sorumlusu. Anahtar kartı misafir odalarını açmaz, sadece hizmet alanlarına erişimi var.",
    bio008: "Güvenlik Görevlisi. Görev sırasında misafir odalarına giremez, sadece devriye ve güvenlik kontrolü yapar.",
    bio009: "Etkinlik Koordinatörü. Tam VIP erişimi var, tüm misafir odalarına giriş yetkisi bulunuyor.",
  },
  locations: {
    ...
    desc007: "Kurbanın Odası (504). Olay yeri, kapı zorla açılmış.",
    desc008: "Servis Koridoru. Personel geçiş alanı, misafir odalarına bağlantılı.",
    desc009: "Merdiven Boşluğu. Acil çıkış alanı, zemin tozlu.",
  },
  weapons: {
    ...
    desc007: "Kırık cam şişe parçası. Kullanıldığında cam kırıkları bırakır.",
    desc008: "Küçük metal levye. Kapıları zorlamak veya açmak için kullanılır.",
    desc009: "Zehirli içecek. Tüketildiğinde ölümcül etki yapar, görsel iz bırakmaz.",
  },
  grid: {
