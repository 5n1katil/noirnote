...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black text-white relative overflow-hidden">
      ...
      <main className="relative z-10 mx-auto flex w-full max-w-6xl flex-col px-4 sm:px-6 py-4 sm:py-6">
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-center gap-6 sm:gap-8 lg:gap-12 mb-6 sm:mb-8">
